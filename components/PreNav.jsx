    ...
    <div className="flex">
      ...
      <div className="w-full flex-[4] md:flex justify-center mx-auto py-3 bg-primary bg-opacity-80">
        <p className="text-center text-xs md:text-sm text-secondary">
          October 2024 learning session start soon.{" "}
          <Link href="" className="underline hover:text-primary duration-200">
            Apply Now!
          </Link>
        </p>
      </div>
      ...
      <Link
        href=""
        className="flex-1 bg-primary justify-center items-center flex gap-2 border-l-2 border-white"
      >
        <div className="text-green-600">
          <IoLogoWhatsapp size={20} />
        </div>
        <p className="text-white md:text-xs text-[8px] hover:underline font-semibold text-ellipsis">
          +234 123 456 789
        </p>
      </Link>
    </div>
