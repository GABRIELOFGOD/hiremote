  ...
  return (
    <div>
      <div className="about md:mb-10 w-full relative md:bg-[url('/images/remote-worker5.jpg')]">
        <div className="content flex flex-col gap-[0.7rem] px-[1rem] py-[3rem] md:px-[8rem] md:py-[10rem] relative z-10 bg-gradient-to-r from-primary to-blue-700  md:from-primary to-transparent bg-opacity-100 text-white">
